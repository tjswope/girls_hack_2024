...
public class GraphicsPanel extends JPanel implements KeyListener{
	...
	private String[] wordlist; //this array holds the list of 5 letter words allowed within wordle.
	
	private String answer; //this String is the word the player is attempting to guess

	private String[] guesses = {"", "", "", "", "", ""}; //this array holds the guesses the player has entered as Strings.
	...
	public GraphicsPanel() {
		...
		//written below the keyTyped method (scroll down to see it).
	...
	//method: getWordList()
	//parameters: none
	//return: String [] - returns the list of words in the wordle library txt file as an array of Strings.
	...
	public void keyTyped(KeyEvent e) {
		...
		if(c == KeyEvent.VK_BACK_SPACE && xAdjust > 0) { //this statement allows players to delete letters before
